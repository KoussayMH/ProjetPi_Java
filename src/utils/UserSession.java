...
public final class UserSession {
    ...
    public static UserSession getInstance(String username, String email, String confirmation_token, int id, int role, int active,String firstname,String lastname) {
        if (instance == null) {
